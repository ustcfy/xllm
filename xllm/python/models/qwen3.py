...
def load_qwen3_backbone(
    ...
    *,
    ...
    """Load every Qwen3-dense decoder layer (norms, attention, MLP) and run post-load finalize."""
    for i, layer in enumerate(layers):
        ...
        loader.copy_in(dst + "mlp.gate_up_proj.weight", loader.pack_gate_up(src + "mlp."))
        loader.copy_in(dst + "mlp.down_proj.weight", loader.load_shard(src + "mlp.down_proj.weight", dim=1))
