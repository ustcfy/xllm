...
class DeepseekV3MLP(nn.Module):
    ...
    def load_from_checkpoint(
        ...
        *,
        ...
        loader.load_w8a8_b(mlp_prefix, world=world, rank=rank)
...
class DeepseekV3MoE(nn.Module):
    ...
    def __init__(
        ...
        self.shared_experts = DeepseekV3MLP(
            ...
            device,
            skip_tp_reduce=True,
            tp_override=effective_moe_tp(cfg),
        )
    ...
    def load_experts(
        ...
        *,
        ...
        Assumes symmetric int8; the checkpoint-level offset assertion is done
        once per-rank in the model's ``load_weights`` before the layer loop.
        """
        ...
        for idx, j in enumerate(range(self.local_expert_start, self.local_expert_end)):
            w, s = loader.load_w8a8_down(f"{src_prefix}{j}.", world=world, rank=rank)
...
class DeepseekV3ForCausalLM(PyModelBase):
    ...
    def load_weights(
        ...
        loader.assert_moe_layer_symmetric_int8(self.model.layers)
